...
KUBE_PROMETHEUS_STACK_HELM_CHART_VERSION="47.4.0"
...
```bash
# renovate: datasource=github-tags depName=aws/karpenter extractVersion=^(?<version>.*)$
KARPENTER_HELM_CHART_VERSION="v0.29.0"
...
CERT_MANAGER_HELM_CHART_VERSION="1.12.2"
...
OAUTH2_PROXY_HELM_CHART_VERSION="6.13.1"
