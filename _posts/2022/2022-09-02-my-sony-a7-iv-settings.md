...
flowchart LR
    ...
    CA1[Setup]              --> CA2(Operations \n Customize) --> CA3("DISP (Screen Disp) \n Set") --> CA4(Finder)                   --> CA5(Display All \n Info.)
    CB1[Setup]              --> CB2(Touch \n Operation)      --> CB3(Touch Operation)             --> CB4(On)
    CC1[Setup]              --> CC2(Touch \n Operation)      --> CC3(Touch Panel/Pad)             --> CC4(Touch Pad Only)
    CD1[Setup]              --> CD2(Touch \n Operation)      --> CD3(Touch Func. \n in Shooting)  --> CD4(Touch Focus)
    CE1[Setup]              --> CE2(Touch \n Operation)      --> CE3(Touch Pad Settings)          --> CE4(Operation Area)           --> CE5(Left 1/2)
    CF1[Setup]              --> CF2(Display \n Option)       --> CF3(Auto Review)                 --> CF4(2s)
    CG1[Setup]              --> CG2(Power Setting \n Option) --> CG3(Auto Power OFF \n Temp.)     --> CG4(High)
    CH1[Setup]              --> CH2(Sound Option)            --> CH3(Audio signals)               --> CH4(Off)
    CI1[Setup]              --> CI2(Setup Option)            --> CI3(Anti-dust Function)          --> CI4(Shutter When \n Pwr OFF)  --> CI5(On)
    CJ1[Setup]              --> CJ2(USB)                     --> CJ3(USB Connection \n Mode)      --> CJ4("MassStorage(MSC)")
```
