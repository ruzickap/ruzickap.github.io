...
SNAPSHOT_CONTROLLER_HELM_CHART_VERSION="1.9.1"
...
MAILPIT_HELM_CHART_VERSION="0.7.6"
...
KUBE_PROMETHEUS_STACK_HELM_CHART_VERSION="51.9.1"
...
```bash
# renovate: datasource=github-tags depName=aws/karpenter extractVersion=^(?<version>.*)$
KARPENTER_HELM_CHART_VERSION="v0.31.1"
...
FORECASTLE_HELM_CHART_VERSION="1.0.131"
