...
tags: [amazon-eks, kubernetes, security, eksctl, cert-manager, external-dns, prometheus]
...
and modify its [default values](https://github.com/kubernetes-sigs/aws-ebs-csi-driver/blob/helm-chart-aws-ebs-csi-driver-2.28.1/charts/aws-ebs-csi-driver/values.yaml):
...
and modify its [default values](https://github.com/cert-manager/cert-manager/blob/v1.14.4/deploy/charts/cert-manager/values.yaml):
...
and modify its [default values](https://github.com/kubernetes/ingress-nginx/blob/helm-chart-4.10.0/charts/ingress-nginx/values.yaml):
...
and modify its [default values](https://github.com/stakater/Forecastle/blob/v1.0.138/deployments/kubernetes/chart/forecastle/values.yaml):
