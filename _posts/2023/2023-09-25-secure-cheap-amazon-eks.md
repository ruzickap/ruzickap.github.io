...
SNAPSHOT_CONTROLLER_HELM_CHART_VERSION="2.0.0"
...
AWS_EBS_CSI_DRIVER_HELM_CHART_VERSION="2.24.1"
...
MAILPIT_HELM_CHART_VERSION="0.7.8"
...
KUBE_PROMETHEUS_STACK_HELM_CHART_VERSION="52.1.0"
...
```bash
# renovate: datasource=github-tags depName=aws/karpenter extractVersion=^(?<version>.*)$
KARPENTER_HELM_CHART_VERSION="v0.32.1"
...
OAUTH2_PROXY_HELM_CHART_VERSION="6.18.1"
