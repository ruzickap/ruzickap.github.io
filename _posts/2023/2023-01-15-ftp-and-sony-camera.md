...
author: Petr Ruzicka
date: 2023-01-15
description: Run an FTP server for transferring photos from Sony cameras
...
FTP is a protocol I haven't used for many years. I have configured FTP servers like [vsftpd](https://security.appspot.com/vsftpd.html) or [ProFTPD](https://github.com/proftpd/proftpd) in the past, but this time, I decided to explore [SFTPGo](https://github.com/drakkan/sftpgo).

![SFTPGo](https://raw.githubusercontent.com/drakkan/sftpgo/5d7f6960f30fc4ba9606d5569dddf8bf5b4764bb/static/img/logo.png)

The main reason I wanted to run my own FTP server on my laptop was to wirelessly transfer photos from my [Sony A7 IV](https://en.wikipedia.org/wiki/Sony_%CE%B17_IV) camera, eliminating the need for cables or SD card swapping.

## SFTPGo

Let's look at how to run an FTP server on macOS.
...
You can check the WebAdmin interface to see the details about the created user at `http://127.0.0.1:8080/web/admin/users`.
...
Now, you need to configure your Sony camera (Sony A7 IV), connect it to Wi-Fi, and set up the FTP transfer.

- Configure Wi-Fi connection to your Access Point / wireless router (or you can create
  [Personal Hotspot](https://support.apple.com/en-us/HT204023) on your iPhone, as I did):
...
> Make sure your Mac is connected to the same Wi-Fi as your Sony camera.
{: .prompt-warning }
<!-- prettier-ignore-end -->
...
The camera configuration, including Wi-Fi configuration, FTP, and photo transfer,
